           ...
           <el-form-item prop="appid" label="缴费编号">
            ...
            <el-form-item label="加密私钥">
                <div class="flex-row align-end">
                    ...
                    <div class="ml-20">
                        <div>
                            原始值：{{formParams.path_key  }}
                            <a class="ml-15" @click="formParams.path_key   = ''" v-if="formParams.path_key  " href="javascript:void(0)">清空</a>
                        </div>
                        <div>如不上传文件将不更改"加密私钥"字段的值</div>
                    </div>
                </div>
            </el-form-item>
            <el-form-item label="解密公钥">
                <div class="flex-row align-end">
                    ...
                    <div class="ml-20">
                        <div>
                            原始值：{{formParams.path_crt }}
                            <a class="ml-15" @click="formParams.path_crt  = ''" v-if="formParams.path_crt " href="javascript:void(0)">清空</a>
                        </div>
                        <div>如不上传文件将不更改"解密公钥"字段的值</div>
                    </div>
                </div>
            </el-form-item>
...
<script>
    import {formParams,
        ...
        crtUploadFile,
        main,keyUploadRef,
        crtUploadRef} from '@/hooks/mch/parametersAbc/update.js'
