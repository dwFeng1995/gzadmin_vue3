    ...
    <div>
        <el-card class="box-card" :body-style="{padding: 0}" shadow="never">
            ...
            <el-table :header-cell-style="{'text-align':'center','color':'#000'}"  border :span-method="objectSpanMethod" :data="tableData" size="small" align="center">
                ...
                <el-table-column align="center"  prop="appid"  label="缴费编号" />
                <el-table-column  align="center"  prop="path_key" label="path_key" />
                <el-table-column  align="center"  prop="path_crt" label="path_crt" />
...
<script>
    import {main, createChildRef, updateChildRef } from '@/hooks/mch/parametersAbc/index.js'
    import Create from '@/views/mch/parametersAbc/Create.vue'
    import Update from '@/views/mch/parametersAbc/Update.vue'
    export default {
        name: "ParametersAbc",
        components: {
            Create,
