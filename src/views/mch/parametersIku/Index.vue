    ...
    <div>
        <el-card class="box-card" :body-style="{padding: 0}" shadow="never">
            ...
            <el-table :header-cell-style="{'text-align':'center','color':'#000'}" border :span-method="objectSpanMethod" :data="tableData" size="small" align="center">
                ...
                <el-table-column align="center" prop="appid" label="缴费项目"/>
                <el-table-column  align="center"  prop="mch_id" label="商户号" />
                <el-table-column  align="center"  prop="secret_key" label="密钥" />
                <el-table-column  align="center"  prop="shop_id" label="店铺id" />
                <el-table-column  align="center"  prop="device_id" label="终端设备id" />
                <el-table-column  align="center"  prop="operator_id" label="员工id" />
                <el-table-column  align="center"  prop="redirect_url" label="重定向地址" />
...
<script>
    import {main, createChildRef, updateChildRef } from '@/hooks/mch/parametersIku/index.js'
    import Create from '@/views/mch/parametersIku/Create.vue'
    import Update from '@/views/mch/parametersIku/Update.vue'
    export default {
        name: "ParametersIku",
        components: {
            Create,
