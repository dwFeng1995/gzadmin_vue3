    ...
    >
      ...
      <el-form-item prop="company_id" label="企业名称">
        <el-select
          filterable
          clearable
          :disabled="formParams.cert_path !== '' || formParams.key_path !== ''"
          class="w-100"
      ...
      <el-form-item label="cert证书">
        <div class="certificate-upload">
          ...
          >
            ...
            <template #tip>
              <div class="el-upload__tip">只能上传.pem文件</div>
            </template>
          </el-upload>
          <el-button @click="keyUploadFile()" size="mini" type="primary"
            >点击上传</el-button
          >
        </div>
      </el-form-item>
      <el-form-item label="key证书">
        <div class="certificate-upload">
          ...
          <el-button @click="pubUploadFile()" size="mini" type="primary"
            >点击上传</el-button
          >
        </div>
      </el-form-item>
...
import {
  ...
  uploadFilePath,
  uploadHeader,
} from "@/hooks/mch/wechatPay/create.js";
