<template>
    <div>
        <el-card class="box-card" :body-style="{padding: 0}" shadow="never">
            ...
            <el-table :header-cell-style="{'text-align':'center','color':'#000'}"  border :span-method="objectSpanMethod" :data="tableData" size="mini" align="center">
                ...
                <el-table-column  align="center"  prop="err_url" label="错误访问链接" />
                <el-table-column  align="center"  prop="pay_cert_file" label="网上平台支付证书" />
                <el-table-column  align="center"  prop="store_file" label="农行根证书文件" />
                <el-table-column  align="center"  prop="store_password" label="农行根证书文件密码" />
                <el-table-column  align="center"  prop="mch_id" label="商户编号" />
                <el-table-column  align="center"  prop="log_path" label="交易日志文件存放目录" />
                <el-table-column  align="center"  prop="merchant_cert_file" label="商户证书储存目录档名" />
                <el-table-column  align="center"  prop="merchant_password" label="商户私钥加密密码" />
            ...
            <div>
                <el-dialog destroy-on-close v-model="createDialogVisible" :close-on-click-modal="false" @close="createDialogClosed" title="添加"   width="800px" top="5vh">
                    <div>
...
<script>
    import {main, createChildRef, updateChildRef } from '@/hooks/mch/parametersAbcCode/index.js'
    import Create from '@/views/mch/parametersAbcCode/Create.vue'
    import Update from '@/views/mch/parametersAbcCode/Update.vue'
    export default {
        name: "ParametersAbcCode",
        components: {
            Create,
            Update
        },
