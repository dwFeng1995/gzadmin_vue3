        ...
        <el-form size="small" :model="formParams" label-width="140px"  :rules="formRules" ref="formRef">
            <PlatformMerchantTips />
             <el-form-item  prop="company_id" label="企业名称">
                <el-select  clearable filterable :disabled="formParams.merchant_cert_file !== ''" class="w-100" v-model="formParams.company_id" placeholder="请选择企业">
                    <el-option
           ...
           <el-form-item prop="appid" label="appid">
                <el-input type="textarea"    :rows="1"  v-model.trim="formParams.appid" />
            </el-form-item>
...
<script>
    import {pfxUploadRef,
        ...
        uploadError,
        uploadSuccess,
        removeFile} from '@/hooks/mch/parametersAbcCode/create.js'
