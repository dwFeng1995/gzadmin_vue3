<template>
    <div>
         <el-card class="box-card" :body-style="{padding: 0}" shadow="never">
            ...
            <div>
                <el-dialog destroy-on-close v-model="createDialogVisible" :close-on-click-modal="false" @close="createDialogClosed" title="添加"   width="688px" >
                    <div>
            ...
            <div>
                <el-dialog destroy-on-close  v-model="updateDialogVisible" :close-on-click-modal="false" @close="updateDialogClosed" title="编辑" width="688px" >
                    <div>
...
<script>
import {main, createChildRef, updateChildRef } from '@/hooks/mch/parametersGezi/index.js'
import Create from '@/views/mch/parametersGezi/Create.vue'
import Update from '@/views/mch/parametersGezi/Update.vue'
export default {
    name: 'ParametersGezi',
    components: {
        Create,
