    ...
    <div>
        <el-card class="box-card" :body-style="{padding: 0}" shadow="never">
            ...
            <el-table :header-cell-style="{'text-align':'center','color':'#000'}" border :span-method="objectSpanMethod" :data="tableData" size="small" align="center">
                ...
                <el-table-column align="center" prop="item_code" label="支付项" />
                <el-table-column  align="center"  prop="private_key_path" label="加密私钥路径" />
                <el-table-column  align="center"  prop="public_key_path" label="解密公钥路径" />
                <el-table-column  align="center" prop="aes_iv" label="aes_iv" />
                <el-table-column  align="center" prop="aes_key" label="aes_key" />
...
<script>
    import {main, createChildRef, updateChildRef } from '@/hooks/mch/parametersPci/index.js'
    import Create from '@/views/mch/parametersPci/Create.vue'
    import Update from '@/views/mch/parametersPci/Update.vue'
    export default {
        name: "ParametersPci",
        components: {
            Create,
