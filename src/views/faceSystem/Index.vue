        ...
        <el-card class="box-card" :body-style="{padding: 0}" shadow="never">
            <div class="ml-20 mt-20 flex-row justify-between align-center ">
                <el-form inline size="small" @submit.prevent="false;">
                    <el-form-item >
                        <el-input v-model.trim="keyWords" placeholder="名称/系统名称/备注"  @keyup.enter="queryData"></el-input>
                    </el-form-item>
                    <el-form-item>
            ...
            <el-table :header-cell-style="{'text-align':'center','color':'#000'}" :data="tableData" size="small" align="center">
                ...
                <el-table-column align="center"  prop="code"  label="系统名称"  />
                <el-table-column align="center"  prop="name"  label="名称"   />
                <el-table-column align="center"  prop="model"  label="模型"   />
                <el-table-column align="center"  prop="remrak"  label="备注" width="220px" />
                ...
                <el-table-column label="操作" align="center" width="180px">
                    <template #default="{row}">
                        <el-button size="mini" type="primary" icon="el-icon-edit"  @click="getFaceSystemDetail(row)">编辑</el-button>
                        <el-button size="mini" type="danger" icon="el-icon-delete"  @click="deleteFaceSystem(row)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <div class="paging">
...
<script>
    import {main, createChildRef, updateChildRef } from '@/hooks/faceSystem/index.js'
    import  Create from '@/views/faceSystem/Create.vue'
    import  Update from '@/views/faceSystem/Update.vue'
    export default {
        name: "FaceSystem",
        components: {
            Create,
