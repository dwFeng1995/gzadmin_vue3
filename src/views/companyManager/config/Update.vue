    ...
    <div>
        <el-form ref="formRef" :model="formParams" :rules="formRules" label-width="80px" size="mini">
            ...
            <el-form-item label="简介" prop="synopsis">
                <Tinymce @getContent="getSynopsisContent" :resize="true"  :htmlContent="formParams.synopsis" />
            </el-form-item>
            <el-form-item label="icp" prop="icp">
                <Tinymce @getContent="getIcpConetnt" :resize="true" :htmlContent="formParams.icp" />
            </el-form-item>
...
<script>
    import {formParams, formRef, getIcpConetnt, getSynopsisContent, formRules, handleAvatarSuccess,
        beforeAvatarUpload, handleAvatarError, uploadHeaders, uploadPath, resetForm, main} from '@/hooks/companyManager/config/update'
