        ...
        <div class="centent pl-12 pr-12">
            <el-form ref="formRef" :model="formParams" size="mini" label-width="120px" :rules="formRules">
                <el-form-item label="食堂编号" prop="canteen_no">
                    <el-input  disabled v-model.trim="formParams.canteen_no" placeholder="请输入食堂编号" maxlength="2"></el-input>
                </el-form-item>
...
<script>
    import  {main, formRef, formRules} from '@/hooks/companyManager/canteen/update'
    export default {
        name: "Create",
        props: {
            detail: {
