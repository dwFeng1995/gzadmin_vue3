    ...
    <div>
        <el-card class="box-card" :body-style="{padding: 0}" shadow="never">
            <div class="ml-20 mt-20 flex-row justify-between align-center ">
                <el-form inline size="small">
                    <el-form-item label="所属：">
                        <el-select filterable  clearable v-model="funTypeId" placeholder="请选择所属">
                            <el-option
            ...
            <el-table :header-cell-style="{'text-align':'center','color':'#000'}" :data="tableData" size="small" align="center">
                ...
                <el-table-column align="center"  prop="fun_name"  label="名称" />
                <el-table-column align="center"  prop="fun_type"  label="模式" />
                ...
                <el-table-column label="操作" align="center" width="180px">
                    <template #default="{row}">
                        <el-button size="mini" type="primary" icon="el-icon-edit"  @click="getClientModelDetail(row)">编辑</el-button>
                        <el-button size="mini" type="danger" icon="el-icon-delete"  @click="deleteClientModel(row)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <div class="paging">
...
<script>
    import {main, createChildRef, updateChildRef } from '@/hooks/client/clientModel/index.js'
    import Create from '@/views/client/clientModel/Create.vue'
    import Update from '@/views/client/clientModel/Update.vue'
    export default {
        name: "ClientModel",
        components: {
            Create,
