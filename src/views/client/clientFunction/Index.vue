    ...
    <div>
        <el-card class="box-card" :body-style="{padding: 0}" shadow="never">
            ...
            <el-table :header-cell-style="{'text-align':'center','color':'#000'}" :data="tableData" size="small" align="center">
                ...
                <el-table-column align="center"  prop="fun_name"  label="名称" width="120px" />
                <el-table-column align="center"  prop="fun_code"  label="代号"  width="120px" />
                <el-table-column align="center"  label="设备类型">
                    <template #default="{row}">
                        <div>
                            <el-tag v-for="item in row?.get_client_type"  class="mr-4 mb-4" size="small" type="success" :key="item.id">
                                {{item.name}}
                            </el-tag>
                        </div>
                    </template>
                ...
                <el-table-column label="操作" align="center" width="180px">
                    <template #default="{row}">
                        <el-button size="mini" type="primary" icon="el-icon-edit"  @click="getClientFunctionDetail(row)">编辑</el-button>
                        <el-button size="mini" type="danger" icon="el-icon-delete"  @click="deleteClientFunction(row)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <div class="paging">
...
<script>
    import {main, createChildRef, updateChildRef } from '@/hooks/client/clientFunction/index.js'
    import  Create from '@/views/client/clientFunction/Create.vue'
    import  Update from '@/views/client/clientFunction/Update.vue'
    export default {
        name: "ClientFunction",
        components: {
            Create,
