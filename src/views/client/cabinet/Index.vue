    ...
    <div>
        <el-card class="box-card" :body-style="{padding: 0}" shadow="never">
            ...
            <el-table :header-cell-style="{'text-align':'center','color':'#000'}" :data="tableData" size="small" align="center">
                <el-table-column align="center"  prop="cabinet_id"  label="设备编号" />
                <el-table-column align="center"  prop="cabinet_name"  label="设备名称" />
                <el-table-column align="center"  prop="describe"  label="备注" />
                <el-table-column align="center"  prop="shop_address"  label="店铺地址" />
                <el-table-column align="center"  prop="shop_phone"  label="店铺电话" />
                <el-table-column align="center"  prop="admin_code"  label="	取餐柜管理员密码" />
...
<script>
    import {main, createChildRef, updateChildRef } from '@/hooks/client/cabinet/index.js'
    import Create from '@/views/client/cabinet/Create.vue'
    import Update from '@/views/client/cabinet/Update.vue'
    export default {
        name: "Cabinet",
        components: {
            Create,
