        ...
        <el-card class="box-card" :body-style="{padding: 0}" shadow="never">
            ...
            <el-table :header-cell-style="{'text-align':'center','color':'#000'}" :data="tableData" size="mini" align="center">
                ...
                <el-table-column label="操作" align="center" width="180px">
                    <template #default="{row}">
                        <el-button size="mini" type="primary" icon="el-icon-edit"  @click="getNutrimentCusDetail(row)">编辑</el-button>
                        <el-button size="mini" type="danger" icon="el-icon-delete"  @click="deleteNutrimentCus(row)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <div class="paging">
...
<script>
    import {main, createChildRef, updateChildRef } from '@/hooks/nutriment/nutrimentCus/index.js'
    import  Create from '@/views/nutriment/nutrimentCus/Create.vue'
    import  Update from '@/views/nutriment/nutrimentCus/Update.vue'
    export default {
        name: "NutrimentCusList",
        components: {
            Create,
            Update
        },
